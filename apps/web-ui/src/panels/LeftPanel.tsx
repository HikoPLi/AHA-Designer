...
export default function LeftPanel() {
  ...
  const filteredLibs = LIBRARY_ITEM.filter(
    (item) =>
    ...
    <aside className="side-panel">
      <div className="panel-header" style={{ paddingBottom: "16px" }}>
        ...
        >
          ...
          <span style={{ fontWeight: 600 }}>Library Explorer</span>
        </div>
            ...
            >
              ...
              >
                ...
                >
                  <span>
                    TDP:{" "}
                    <strong style={{ color: "#e2e8f0" }}>{item.tdp}W</strong>
                  </span>
